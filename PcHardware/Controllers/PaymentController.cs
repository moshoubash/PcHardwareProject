...
namespace PcHardware.Controllers
{
    ...
    public class PaymentController : Controller
    {
        ...
        public async Task<ActionResult> Checkout(Models.Address address, decimal TotalAmount, string stripeToken)
        {
            ...
            if (int.Parse(TempData["DiscountId"].ToString()) != null)
            {
                var notification = new Notification { Type = "Use Discount", Description = $"User {user.Id} use discount : {int.Parse(TempData["DiscountId"].ToString())} on order {order.Id}", Time = DateTime.Now, IsRead = false };
            ...
            var notify = new Notification { Type = "New Order", Description = $"User {user.Id} make a new order {order.Id}", Time = DateTime.Now, IsRead = false };
